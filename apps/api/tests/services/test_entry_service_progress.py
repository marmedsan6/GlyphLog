"""Tests de servicio para seguimiento de progreso.

Cobertura: bloqueo por historial, reset de progreso, actualización manual
de progreso e historial. A nivel de servicio — no requiere cliente HTTP.
"""
...
class TestEntryServiceManualProgressUpdate:
    ...
    async def test_update_progress_mark_completed_ignored_if_not_total(
        ...
        update_payload = mock_entry_repo.update.call_args[0][2]
        assert update_payload.status is None
